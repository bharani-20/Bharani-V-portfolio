...
export const profileData: ProfileData = {
  ...
  bio: `I'm a passionate Frontend Developer with 1+ years of experience building
  ...
  skills: [
    ...
    { name: 'CSS', icon: 'FaCss3Alt', level: 88, category: 'frontend' },
    { name: 'JavaScript', icon: 'SiJavascript', level: 92, category: 'frontend' },
    ...
    { name: 'Supabase', icon: 'SiSupabase', level: 55, category: 'database' },
    ...
    { name: 'Figma', icon: 'FaFigma', level: 93, category: 'tools' },
  ],
  ...
  socialLinks: [
    ...
    {
      platform: 'Instagram',
      url: 'https://www.instagram.com/bharan_2007?igsh=aWR2c3d2anVpaWF',
      icon: 'FaInstagram',
      color: '#E1306C',
